...
void loop()
{
  ...
  while (t < 4000 || t > 5000) {
    ...
    //   // if (t > 3500 && t < 4500) Serial.println(t);
    // }
  }

  if (DEBUG) {
    Serial.print("AGC Prime: ");
    Serial.println(t);
  ...
  while (t < 1500 || t > 2500) {
    ...
    // if (DEBUG) { // For finding AGC timings
    //   if (t > 1500 && t < 2500) Serial.println(t);
    // }
  }
  ...
  while (t < 1200 || t > 2200) {
    ...
    // if (DEBUG) { // For finding AGC timings
    //   if (t > 1200 && t < 2200) Serial.println(t);
    // }
  }
  ...
  while (i < 40) {
    ...
    if (t > 550 && t < 1000) { // Found 1
      command += "1";
      if (DEBUG) Serial.println("1");
      
    } else if (t > 200 && t < 549) { // Found 0
      command += "0";
...
Serial.println(); // Move to next line after printing all characters
